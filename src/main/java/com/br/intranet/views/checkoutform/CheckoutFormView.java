package com.br.intranet.views.checkoutform;
...
@RolesAllowed("ADMIN")
public class CheckoutFormView extends HorizontalLayout {
    ...
    public CheckoutFormView() {
        addClassNames("checkout-form-view", Width.FULL, Display.FLEX, Flex.AUTO);
        setSpacing(false);
